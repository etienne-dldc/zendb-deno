...
export function createColumn<Dt extends Datatype>(
  datatype: Dt
): Column<Dt, false, null> {
...
export function serializeColumn(
  ...
  if (data === undefined || data === null) {
    ...
    throw new Error(
      `Received null or undefined for non-nullable column ${name}`
    );
  }
